...
(function () {
    ...
    Q.RotateTag = function (aP, aI, aO, i, aM, aH) {
        var aN = aP.xformed, aK = new ae(aN.x, aN.y, aN.z), aJ = aj(aO, aI), j = aK.angle(aJ), aL = aK.cross(aJ).unit();
        if (j == 0) {
            this.fixedCallbackTag = aP;
            this.fixedCallback = aM
        } else {
            this.fixedAnim = {angle: -j, axis: aL, t: i, t0: G(), cb: aM, tag: aP, active: aH}
        }
    };
